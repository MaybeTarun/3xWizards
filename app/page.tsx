    ...
    <div className="w-dvw h-dvh bg-[#0a0a0a]">
      ...
      <div className="h-fit w-full flex items-center justify-between p-4">
        ...
        <div className="flex gap-2 md:gap-4 items-center w-fit h-full text-[#f0f0f0] z-10">
          ...
          <div className="cursor-pointer border-[1px] py-2 px-6 rounded-full hover:bg-[#ffffff1c] text-sm md:text-base z-10">Connect Wallet</div>
        </div>
      </div>
      {/* home */}
      ...
      <p className="h-fit w-full text-[#f0f0f0b0] text-center pt-1 md:pt-4 text-sm md:text-lg z-10">Unlock hassle-free, secure borrowing and embrace the<br/>future of lending with zkLend today.</p>
      <div className="flex gap-2 md:gap-4 items-center justify-center w-full h-fit py-2 md:py-4 z-10">
          <div className="cursor-pointer py-2 px-6 rounded-full text-[#0a0a0a] bg-[#f0f0f0] hover:bg-[#ffffff1c] hover:text-[#f0f0f0] text-sm md:text-base z-10">Take/Repay Loan</div>
